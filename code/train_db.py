...
"""
    ...
    tags = ["text-to-image", "dreambooth", "diffusers-training", "CoRe"]
...
def log_validation(
    ...
    evaluator, 
    original_is=None, original_ts=None
):
    logger.info(
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        default=None,
        required=True,
        help="A folder containing the testing data of instance images.",
    )
...
def main(args):
    ...
    # print('\n args.mixed_precision: ', args.mixed_precision)

    accelerator = Accelerator(
        gradient_accumulation_steps=args.gradient_accumulation_steps,
        mixed_precision=None, # args.mixed_precision,
        log_with=args.report_to,
        project_config=accelerator_project_config,
    )

    # print('\n accelerator.mixed_precision: ', accelerator.mixed_precision)
    ...
    initializer_token_id = tokenizer.convert_tokens_to_ids([args.initializer_token])[0]
    ...
    state_dict = torch.load(os.path.join(args.output_dir, "text_encoder.bin"))
    ...
    if args.pre_compute_text_embeddings:
        # save_path = os.path.join(args.output_dir, "text_encoder.pth")
        # text_encoder.load_state_dict(torch.load(save_path))
    ...
    if accelerator.is_main_process:
        ...
        accelerator.init_trackers("CoRe", config=tracker_config)
